...
@Injectable()
export class ValidarSiExisteComentarioDesdeLetraConstraint implements ValidatorConstraintInterface  {
  ...
  async validate(value: any, args) {
    ...
    const comentario = await ComentarioPorUUID( object['ComentarioId'] )
  ...
  defaultMessage(args: ValidationArguments) {
    ...
    return `No se encontro ningun comentario con este id: ${ object['ComentarioId'] }.`
  }
}
