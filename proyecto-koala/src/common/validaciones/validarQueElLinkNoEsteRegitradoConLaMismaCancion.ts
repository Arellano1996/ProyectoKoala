...
export class validarQueElLinkNoEsteRegitradoConLaMismaCancion {
  ...
  async validate(value: any, args: ValidationArguments) {
    ...
    const validarSiElUsuarioYaRegistroElLinkEnLaCancion = await LinksConCancionYUsuarioPorCancionUUIDUsuarioUUIDYURL(object['CancionId'], object['UsuarioId'], object['URL'])
