...
@Injectable()
export class ValidarSiExisteConfiguracionConstraint implements ValidatorConstraintInterface  {
  ...
  async validate(value: any, args) {
    ...
    const configuracion = await ConfiguracionPorUUID( object['id'] )
  ...
  defaultMessage(args: ValidationArguments) {
    ...
    return `No se encontro ninguna configuración con este id.`
  }
}
